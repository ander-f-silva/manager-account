...
class AccountsResource {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Patch("/{id}/deposit")
  public HttpResponse<?> depositValueInAccount(
      @PathVariable("id") UUID id, @Valid @Body DepositAccountDTO depositAccount) {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Patch("/{id}/transfer")
  public HttpResponse<?> transferValueToAccount(
      @JsonSerialize(contentUsing = UUIDSerializer.class) @PathVariable("id") UUID toAccountId,
